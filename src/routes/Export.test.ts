...
describe("Export component", () => {
  test("export region shows code", () => {
    ...
    expect(code).toHaveTextContent(
      `"source": "rootloops.sh?sugar=7&colors=6&sogginess=4&flavor=1&fruit=10&milk=0",`,
    );
  });
  ...
  test.each([
    ["JSON", `"source": "rootloops.sh?sugar=7&colors=6&sogginess=4&flavor=1&fruit=10&milk=0",`],
