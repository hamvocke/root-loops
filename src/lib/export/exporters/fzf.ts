...
export FZF_DEFAULT_OPTS="\
  --color=fg:${cereals.brightWhite.color_hex},fg+:${cereals.brightWhite.color_hex},bg:${cereals.black.color_hex},bg+:${cereals.brightBlack.color_hex} \\
  ...
  --color=border:${cereals.brightBlack.color_hex},label:${cereals.white.color_hex},query:${cereals.brightWhite.color_hex}"`;
}
