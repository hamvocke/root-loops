...
function VSCodeUI(cereals: Cereals) {
  return {
    ...
    "editor.findMatchBackground": cereals.brightYellow.color_hex,
    "editor.findMatchHighlightBackground": cereals.yellow.color_hex,
    "editor.hoverHighlightBackground": cereals.brightBlack.color_hex,
    "editor.lineHighlightBackground": cereals.black.color_hex,
    "editor.selectionBackground": cereals.brightBlack.color_hex,
    "editor.selectionHighlightBackground": cereals.brightYellow.color_hex,
    "editor.wordHighlightBackground": cereals.brightBlack.color_hex,
